export const mockDashboard = {
  ...
  realTimeEvents: [
    { id: 1, time: '14:32', description: 'Queda detectada — D...', color: 'red' as const },
    { id: 2, time: '14:30', description: 'BPM: 82 — SpO2: 96%', color: 'blue' as const },
    { id: 3, time: '14:25', description: 'Status normal — Seu J...', color: 'green' as const },
  ],
};
